...
class TestOMOPToCCDAConverter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.converter = OMOPToCCDAConverter(data_source=self.temp_dir)
    ...
    def test_format_datetime(self):
        ...
        self.assertEqual(self.converter._format_datetime("2023-01-15 10:30:00"), "20230115103000")
    ...
    def test_convert_to_ccda(self):
        ...
        ccda_xml = self.converter.convert_to_ccda(person_data, [], [], [])
